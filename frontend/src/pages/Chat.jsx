                ...
                return (
                  <div key={m.id} style={{ alignSelf: esMio ? 'flex-end' : 'flex-start', maxWidth: '70%' }}>
                    ...
                    <div style={{
                      ...
                      {m.fileData && (
                        esImagen(m.mimeType) ? (
                          <img src={m.fileData} alt={m.fileName} style={{ maxWidth: '100%', borderRadius: 8, marginTop: m.content ? 6 : 0, display: 'block' }} />
                        ) : (
                          
                            href={m.fileData}
                            download={m.fileName}
                            style={{ display: 'block', marginTop: m.content ? 6 : 0, color: esMio ? '#fff' : 'var(--primary)', textDecoration: 'underline', fontSize: 13 }}
                          >
                            📎 {m.fileName}
                          </a>
                        )
